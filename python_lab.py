...
a = 2304811//47
b = 47 * a
remainder_without_mod = 2304811 - b
...
X2 = { 1, 2, 3 }
Y2 = { 4, 5, 6 }
{x*y for x in X2 for y in Y2 if (x*y) % 4 != 0}
...
S_intersect_T = {1*t for t in T if t in S}
...
example_L = [1,3,3,5]
print example_L
test = len(example_L) != len(list(set(example_L)))
print test
...
n = 100
odd_num_list_range = [range(n)[1::2]]
